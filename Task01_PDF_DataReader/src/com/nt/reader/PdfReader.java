...
//====================================================		 
		 //pass into BO object
		 Pdf p1 = new Pdf(str, str, str, str, str, str, str, str);
		 System.out.print("Recommended_Grid_AED\t"); 
		...
		p1.setRecommended_Grid_AED("\tLess Than 1M\t");
		System.out.print(p1.getRecommended_Grid_AED()+"\t");
		p1.setOne_Week("0.00%");
...
//=========================================================
		 //pass into BO object
		 Pdf p2 = new Pdf(str, str, str, str, str, str, str, str);
		p2.setRecommended_Grid_AED("\t1M to Less Then 10M\t");
		System.out.print(p2.getRecommended_Grid_AED()+"\t");
		p2.setOne_Week("0.00%");
		...
		//==============================================================
		 //pass into BO object
		 Pdf p3 = new Pdf(str, str, str, str, str, str, str, str);
		p3.setRecommended_Grid_AED("\t10M or More\t");
		System.out.print(p3.getRecommended_Grid_AED()+"\t");
		p3.setOne_Week("0.00%");
