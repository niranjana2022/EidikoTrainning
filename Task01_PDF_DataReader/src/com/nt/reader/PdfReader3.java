...
import com.nt.bo.Pdf3;
public class PdfReader3 {
...
//====================================================		 
		 //pass into BO object
		 Pdf3 p1 = new Pdf3(str, str, str, str, str, str, str, str);
		 System.out.print("Recommended_Grid_EUR\t"); 
		...
		p1.setRecommended_Grid_EUR("\tLess Than 1M\t");
		System.out.print(p1.getRecommended_Grid_EUR()+"\t");
		p1.setOne_Week("0.00%");
...
//=========================================================
		 //pass into BO object
		 Pdf3 p2 = new Pdf3(str, str, str, str, str, str, str, str);
		p2.setRecommended_Grid_EUR("\t1M to Less Then 10M\t");
		System.out.print(p2.getRecommended_Grid_EUR()+"\t");
		p2.setOne_Week("0.00%");
		...
		//==============================================================
		 //pass into BO object
		 Pdf3 p3 = new Pdf3(str, str, str, str, str, str, str, str);
		p3.setRecommended_Grid_EUR("\t10M or More\t");
		System.out.print(p3.getRecommended_Grid_EUR()+"\t");
		p3.setOne_Week("0.00%");
