/*
  ...
  @Table(name="emptabdata") public class Employee {
  
  @GeneratedValue(strategy = GenerationType.AUTO) private Integer eId;
  ...
  public String geteAddrs() { return eAddrs; } 
  public void seteAddrs(String eAddrs) { this.eAddrs = eAddrs; }
  
  @Override public String toString() { return "Employee [eId=" + eId +
  ", eName=" + eName + ", eAddrs=" + eAddrs + "]"; }
