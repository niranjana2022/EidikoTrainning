...
//		Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/projecteidiko","root","root");
//
//		//statement/query
//		Statement stmt=con.createStatement();
//		ResultSet rs=stmt.executeQuery("select * from excel_todbtable");
//		
//		//Excel
...
//		
//		
//		FileOutputStream fos=new FileOutputStream("C:\\Users\\Sreenivas Bandaru\\Downloads\\Eidiko\\locations1.xlsx");
//		workbook.write(fos);
//		
//		workbook.close();
//		fos.close();
